...
function SingleView(props) {
  ...
  // console.log("entity: ", Date.now(), entity);
    ...
    <div className="movie-details">
      <div className="movie-details__content">
        <div className="movie-details__poster">
          <img
            src={entity.plprogram$thumbnails["orig-365x251"]?.plprogram$url}
            alt={entity.title}
          />
        </div>
        <div className="info_container">
          <div className="movie-details__header">
            ...
            {entity.plprogram$programType === "movie" ? (
              <div className="genre">
              ...
              <div className="genre">
                <div>
                  <span className="genre-title">Sæsoner: </span>
                  {entity.plprogram$seriesTvSeasons
                    .map((season, i) => {
                      const seasons = season.plprogram$tvSeasonNumber;
                      return <span key={i}>{seasons}</span>;
                    })
                    .reduce((prev, curr, index) => [prev, <span key={index}>,&nbsp;</span>, curr])}
                </div>
              </div>
